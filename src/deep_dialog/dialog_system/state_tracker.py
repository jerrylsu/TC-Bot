...
class StateTracker:
    ...
    def get_state_for_agent(self):
        ...
        state = {'user_action': self.history_dictionaries[-1] if len(self.history_dictionaries) > 0 else None, 'current_slots': self.current_slots, #'kb_results': self.kb_results_for_state(),
